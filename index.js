...
let x =  Math.floor(Math.random()*randomQuotes.length);
document.getElementById("quotes").innerHTML = `"${randomQuotes[x]}"`;
document.getElementById("no").innerHTML = `${x + 1}`
}
document.addEventListener("keypress",randomizeQuote)
